...
root mod $2$ and e.g.\ $(a,b,c) = (3,5,15)$ violates the conclusion there. The accompanying Lean formalisation (Section~\ref{sec:theorem}) proves the
...
\url{https://github.com/jpbald93/cross-base-artin-correlations}, including the
